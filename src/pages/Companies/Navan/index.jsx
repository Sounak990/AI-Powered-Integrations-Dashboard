  ...
  const handleStartRecording = async () => {
    ...
    try {
      ...
      const demeanorContent = () => {
        ...
        return `Imagine you are the Senior Director of Financial Operations at Patreon. Your name is Crystal Ryu.
        ...
        Patreon uses Expensify for travel expense management.
        ...
        Never ask "what can I assist you with today?" or "did you have any additional questions?" or "is there anything specific you'd like to know?".
        
        Use contraction words to sound less formal. Keep a relaxed and conversational tone. This should sound like a very natural cold call conversation.`
        ...
        await vapi.start({
          ...
          "model": {
            ...
            //     "topK": 2,
            //     "fileIds": [
            //       "6567083b-c337-448f-b622-c3bc85985f17"
            //     ],
            //     "provider": "canonical"
            //   }
          },
            ...
            <Card className="shadow">
              <CardBody>
                ...
                <div className="persona-details">
                  <p><strong>Name:</strong> Crystal Ryu</p>
                  <p><strong>Title:</strong> Senior Director of Financial Operations</p>
                  <p><strong>Company:</strong> Patreon</p>
                </div>
              </CardBody>
            </Card>
          </Col>
